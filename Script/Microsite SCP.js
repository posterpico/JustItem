"use strict";
(self.webpackChunk_shopee_page_builder_pcmall = self.webpackChunk_shopee_page_builder_pcmall || []).push([[2781], {
    26474: (t, e, s) => {
        s.r(e),
        s.d(e, {
            Collection: () => ve,
        ...
        function _(t) {
            return function(e) {
                return (0,
                m.jsx)(d.Consumer, {
                    children: ({item: s, locale: i, manifest: o}) => (0,
                    m.jsx)(t, (0,
                    c.Z)({
                        item: s,
                        locale: i,
        ...
        class h extends i.Component {
            constructor(t) {
                super(t);
                const {item: e, locale: s, manifest: i} = t;
                this.state = {
                    item: e,
                    locale: s,
                    manifest: i
            ...
            componentDidUpdate(t) {
                const {item: e, locale: s, manifest: i} = this.props
                  , {item: o, manifest: n} = t;
        ...
        var w = s(56008);
        const N = ({className: t, soldOutText: e, i18nCollection: s}) => {
            const i = (0,
            w.Z)(s, ["text_sold_out"], "");
            return (0,
            m.jsx)("div", {
        ...
        const M = ({item: t, isUserAdult: e, adultAge: s, getImageUrl: i, className: o, placeholderClassName: n, children: a, maskAdultImageWhenApplicable: l, useTransparentBackgroundImage: c, useThumbnailImage: d=!0, showSoldOutBadge: _=!0, i18nCollection: u}) => {
            var h;
            const p = (0,
            g.Kd)()
        ...
        const F = _(( ({item: t, className: e, enableGeneratedName: s=!1}) => {
            const i = (0,
            w.Z)(t, ["autogen_title"], null)
              , o = s && i;
            return t && (t.name || o) ? (0,
            m.jsx)("div", {
                "aria-hidden": "true",
        ...
        let P = function(t) {
            ...
            t.OFFICIAL_SHOP = "OFFICIAL_SHOP",
            t.SBS = "SBS",
            t.PREFERRED_PLUS = "PREFERRED_PLUS",
            t.TOP_PRODUCTS = "TOP_PRODUCTS",
            t.S_MART = "S_MART",
            t.PREMIUM = "PREMIUM",
            t.MALL_FBS = "MALL_FBS",
            t.FLAGSHIP_SHOP = "FLAGSHIP_SHOP",
            t.CHOICE = "CHOICE",
            t
        }({});
        P.CUSTOM,
        ...
        var W = t => {
            ...
            try {
                return !(!self || !self[t] || (self[t].setItem(e, e),
                self[t].removeItem(e),
                0))
            } catch (s) {
                return !1
        ...
        var z, q, J = s(19194), tt = Object.freeze({
            INIT: 0,
            REQ: 1,
            OK: 2,
            ERR: 3
        ...
        tt), st = s(85326), it = function(t, e, s) {
            if (Array.isArray(e) && e.length)
                for (let i = 0, o = e.length; i < o; i++) {
                    const o = e[i];
                    if (!t || !Object.prototype.hasOwnProperty.call(t, o))
        ...
        (q = z || (z = {}))[q.UNKNOWN = 0] = "UNKNOWN",
        q[q.LOGGED_IN = 1] = "LOGGED_IN",
        q[q.NOT_LOGGED_IN = 2] = "NOT_LOGGED_IN",
        J.M9,
        J.Rv,
        J.s,
        J.eF,
        ...
        J.F1;
        const ot = () => {
            const {actions: t, state: e} = (0,
            i.useContext)(G.AccountContext)
              , s = (t => {
                const e = it(t, ["info"])
                  , s = it(e, ["userid"], null)
              ...
              , {accountStatus: o, accountInfo: {username: n, portrait: r}} = s;
            return (0,
            i.useEffect)(( () => {
                var t;
                o === z.LOGGED_IN ? (t = {
        ...
        const at = "c4uE7i"
          , lt = i.useContext
          , ct = (0,
        a.withRouter)(( ({item: t, setting: e, history: s, trackingData: i}) => {
            const o = lt(H.Em)
              , {deep_discount_ongoing_status: n} = t
              , r = n > 1
              , a = (0,
            j.useTrackClick)("ActionButton", i)
              , {accountInfo: l, accountStatus: c} = ot()
              , d = c === z.LOGGED_IN
            ...
            m.jsx)(D.Z, {
                onClick: () => {
                    a(),
                    _ ? s.push(rt(t.shopid, t.itemid)) : o(t.shopid, t.itemid)
                }
                ,
                type: "primary",
                className: at,
        ...
        var mt = s(82638)
          , dt = s(43207)
          , _t = s(44400);
        const ut = dt.timeLocales[(0,
        _t.R)((0,
        g.Kd)(), (0,
        g.of)())]
          , ht = dt.formatTime.bind(null, ut);
        function pt(t, e, s) {
            return "date_and_time" === s ? `${ht(1e3 * t, {
                month: "short",
                day: "short"
            })} ${ht(1e3 * t, "hh:mm")}-${ht(1e3 * e, "hh:mm")}` : `${ht(1e3 * t, "hh:mm")}-${ht(1e3 * e, "hh:mm")}`
        }
        const St = function({backgroundColor: t, start: e, end: s}) {
            return (0,
            m.jsxs)("div", {
                className: "Rv1Q4F",
                children: [(0,
        ...
        const Ct = {
          ...
          , Nt = function({item: t}) {
            ...
            m.jsxs)("p", {
                ...
                m.jsx)("span", {
                    "aria-label": (0,
                    v.t)("item_card_promotion_label_webfe_accessibility")
        ...
        function At(t, e) {
            const {key: s, timespan: i} = function(t) {
                return t > 3600 ? {
        ...
        function Lt(t) {
            const e = (0,
            mt.getCurrencyConfig)(__LOCALE__);
            ...
            case mt.SYMBOL_POSITION.FRONT:
                ...
                m.jsxs)(i.Fragment, {
                    ...
                    mt.formatCurrencyNumber)(__LOCALE__, (0,
                    mt.deflateServerNumber)(t, __LOCALE__))]
                });
            case mt.SYMBOL_POSITION.BACK:
                ...
                m.jsxs)(i.Fragment, {
                    children: [(0,
                    mt.formatCurrencyNumber)(__LOCALE__, (0,
                    mt.deflateServerNumber)(t, __LOCALE__)), (0,
                    m.jsx)("span", {
                        className: It.promotionPriceSymbol,
        ...
        const Ot = (0,
        a.withRouter)(( ({item: t, ImageFlag: e, setting: s, usage: i, index: o, promotionId: n, isUserAdult: c, adultAge: d}) => {
            const _ = {
                item: t,
                index: o,
                itemStatus: {
              ...
              , u = (0,
            j.useTrackImpression)("Item", _)
              , h = (0,
            j.useTrackClick)("Item", _);
            if (!t)
                return null;
            const {deep_discount_ongoing_status: S} = t
              , I = S > 1
              , g = s.product_card_timeslot && s.product_card_timeslot.show
              , E = s.product_card_timeslot && s.product_card_timeslot.background_color
              , C = s.style.deep_discount_price_color || s.style.dd_price_color
              , f = t.price_before_dd
              , w = t.deep_discount_price
              , N = !I && t.hidden_deep_discount_price_pc
              , x = t.is_deep_discount_soldout;
            return (0,
            m.jsxs)("div", {
                ref: u,
                    ...
                    m.jsxs)(a.Link, {
                        ...
                        m.jsxs)("div", {
                            ...
                            m.jsx)("span", {
                                ...
                                "aria-hidden": "true",
                                children: (0,
                                mt.formatCurrency)(__LOCALE__, (0,
                                mt.deflateServerNumber)(f, __LOCALE__))
                            }), (0,
                            m.jsx)("span", {
        ...
        function Ft(t) {
            let {direction: e, showArrowOnHover: s, isShown: i, handleClick: o, showArrowHint: n, isVisible: a, padding: l, IconArrow: d, style: _, ariaContent: u} = t
              , h = (0,
            yt.Z)(t, Ut);
            const p = s && n && !i;
            return l = l || "0px",
        ...
        class Pt extends i.Component {
            constructor(t) {
                ...
                this.getFirstItemWidth = this.getFirstItemWidth.bind(this),
                this._carouselContainer = i.createRef(),
                this._carouselList = i.createRef(),
                this._carouselItems = [],
                this._firstItemWidth = null,
                this._carouselContainerWidth = null,
                this._finishSlidingTimeout = null
            }
            componentWillUnmount() {
                this._carouselItems = []
            }
            componentDidMount() {
                const {numItemsPerRow: t, focusIndex: e} = this.props
                  , s = this.props.items ? this.props.items.length : 0;
                if ("number" == typeof e) {
            ...
            componentDidUpdate(t) {
                if (t.numItemsPerRow !== this.props.numItemsPerRow) {
                    ...
                    const {_carouselList: t, state: {position: e}} = this
                      , s = Math.max(0, Math.min(e, this.props.items.length - this.props.numItemsPerRow));
                    t.current && (t.current.style.transition = "0ms",
                    t.current.style.transform = this.getCurrentCarouselTransform(s)),
            ...
            renderDisplayedItems() {
                const {items: t, isFluid: e, padding: s, distributeCardWidthWhenFewerItems: i, numItemsPerRow: o} = this.props
                  , n = t.length
                  , a = i && n < o ? 100 / n : 100 / o;
                return t.map(( (t, i) => (0,
                m.jsx)("li", {
            ...
            render() {
                var t;
                const {items: e, numItemsPerRow: s, showArrowOnHover: i, showArrowHint: o, isFluid: n, distributeCardWidthWhenFewerItems: a, itemPadding: l, className: d, wrapperProps: _, IconArrowLeft: u, IconArrowRight: h, arrowStyle: p, leftArrowProps: S, rightArrowProps: I} = this.props
                  , {isShowArrows: T, position: g} = this.state
                  , E = e.length
                  , C = E > s ? (a && E < s ? 100 / E : 100 / s) * E : 100
                  , f = this._carouselItems && this._carouselItems[this.state.position] ? (null == (t = this._carouselItems[this.state.position]) ? void 0 : t.getBoundingClientRect().width) + "px" : null;
                return (0,
                m.jsxs)("div", {
            ...
            getCurrentCarouselTransform(t) {
                const {_carouselItems: e} = this;
                let s = 0;
                return this.props.isFluid && e ? (s = e.map(( (e, s) => e && s < t ? e.getBoundingClientRect().width : 0)).reduce(( (t, e) => t + e), 0),
                `translate(${-s}px, 0px)`) : (s = this.getCarouselContainerWidth() / this.props.numItemsPerRow,
                `translate(${-t * s}px, 0px)`)
            }
            animateCarousel(t, e, s=100) {
                const {_carouselList: i} = this;
                if (!i.current)
                    return;
                const o = -1 * t * this.getFirstItemWidth();
                i.current.style.transition = `${s}ms`,
                i.current.style.transform = `translate(${o + e}px, 0px)`
            }
            touchMove(t) {
                ...
                0 === this.state.position && (i = Math.min(i, 0)),
                this.state.position >= this.props.items.length - Math.floor(this.props.numItemsPerRow) && (i = Math.max(i, 0)),
                !this._swipeMoved) {
                    const t = s - this._swipeStartY;
                    this.isSwiping = Math.abs(i) > Math.abs(t) && Math.abs(i) > 3,
                    (this.isSwiping || Math.abs(t) > 3) && (this._swipeMoved = !0,
                    this._swipeStartX = e,
                    i = e - this._swipeStartX)
                }
                this.isSwiping && (this.animateCarousel(this.state.position, i),
                this._swipeVx = .5 * this._swipeVx + .5 * (e - this._swipeLastX),
                this._swipeLastX = e)
            }
            touchStart(t) {
                t.stopPropagation(),
                this._swipeStartX = t.changedTouches[0].pageX,
                this._swipeStartY = t.changedTouches[0].pageY,
                this._swipeStarted = !0,
                this._swipeVx = 0,
                this._swipeLastX = this._swipeStartX,
                this._swipeMoved = !1
            }
            touchEnd(t) {
                if (!this._swipeStarted || !this.isSwiping)
                    return;
                this._swipeStarted = !1,
                this._swipeMoved = !1,
                this.isSwiping = !1,
                ...
                Math.abs(this._swipeVx) > 5 ? this._swipeVx > 0 ? s -= 1 : s += 1 : e > .5 * this.getCarouselContainerWidth() ? s -= 1 : e < .5 * -this.getCarouselContainerWidth() && (s += 1),
                this.animateCarousel(s, 0, 100),
                s > this.state.position && this.handleNextArrowClick(),
                s < this.state.position && this.handlePrevArrowClick()
            }
            getFirstItemWidth() {
                return null !== this._firstItemWidth ? this._firstItemWidth : this._carouselList.current && this._carouselList.current.firstElementChild ? (this._firstItemWidth = this._carouselList.current.firstElementChild.getBoundingClientRect().width,
                this._firstItemWidth) : 0
            }
            ...
            handleNextArrowClick() {
                const {items: t, numItemsPerRow: e, slidesByOne: s} = this.props
                  , i = t.length
                  , o = i % 2 == 0 ? i - Math.floor(e) : i + 1 - Math.floor(e)
            ...
            slideTo(t) {
                if (this.state.isSliding && !this.props.isOverrideSliding)
                    return;
                this._finishSlidingTimeout && clearTimeout(this._finishSlidingTimeout);
                const {transitionTime: e} = this.props;
                this.setState({
                    isSliding: !0
                });
                const {_carouselList: s} = this;
                s.current && (s.current.style.transition = `${e}ms`,
                s.current.style.transform = this.getCurrentCarouselTransform(t)),
                "function" == typeof this.props.onSlide && this.props.onSlide(t),
                this.props.isOverrideSliding && this.setState({
                    position: t
                }),
                this._finishSlidingTimeout = setTimeout(( () => {
        ...
        const kt = 1e3
          , Bt = async t => {
            if (!Array.isArray(t.items) || 0 === t.items.length)
                throw new Error("query.items is empty");
            const {items: e, limit: s=kt, deboost_soldout_items: i, same_day: o} = t
              , n = await (0,
            Gt.C8)("/api/v4/microsite/get_items", {
                promo_item_list: e,
                item_limit: 120,
                deboost_soldout_items: i,
                same_day: o
            });
            if (!n || !n.response || n.response.error || n.error)
                throw new Error(n.response);
        ...
        ( () => {
            ...
            "/m/preview" === t && (e.includes("__mobile__=1") || e.includes("__mobile__=true")) || (0,
            Xt.gn)() || (0,
            Xt.Dt)()
        }
        )();
        ...
        new Set(zt);
        !("/m/preview" !== location.pathname || !location.search.includes("__mobile__=1") && !location.search.includes("__mobile__=true")) || (0,
        Xt.gn)() || (0,
        Xt.Dt)();
        Kt.K0,
        Vt.uT.SHOPEE_PAGE_HEADER,
        Kt.GA,
        Kt._P,
        Kt.K0,
        Vt.uT.SOCIAL_SHARING,
        Vt.uT.SHOPEE_PAGE_FOOTER,
        Kt.GA,
        Kt._P,
        Math.min((0,
        Yt.z)(), Kt.Gl);
        Vt.TN.PRODUCT_COLLECTION_CAROUSEL,
        Vt.TN.TWO_ROW_COLLECTION,
        Vt.TN.PRODUCT_COLLECTION_CAROUSEL_2,
        Vt.TN.SHOP_CAROUSEL,
        Vt.TN.ADD_ON_DEAL,
        s(33329),
        s(4192),
        ...
        const te = ["sectionLocation", "meta"]
          , ee = i.useMemo
          , se = ((0,
        Ht.getCountryConfig)(v.config.LOCALE) || {}).adultAge || 0
          , ie = v.I18n.withI18nCollections([Dt.pq, 34])((oe = function(t) {
            let {sectionLocation: e, meta: s} = t
              , i = (0,
            yt.Z)(t, te);
            const {ItemCardBadges: n} = o().useContext($t)
              , {accountInfo: r} = ot()
              , {username: a, birthTimestamp: d, adultConsentTimestamp: _} = r
              , u = ee(( () => (0,
            bt.Eg)({
                username: a,
                birthTimestamp: d,
                adultConsentTimestamp: _
            }, se, v.config.LOCALE).isUserAdult), [a, d, _])
              , h = ee(( () => {
                const t = {};
                for (const e of i.promo_item_list)
                    t[qt(e.shop_id, e.item_id)] = e.promotion_id;
                return t
            }
            ), [i.promo_item_list])
              , {data: p} = (0,
            Mt.a)(["deep-discount-teaser-items"], (async () => (await Jt(( () => {
                var t;
                return Bt({
              ...
              , I = l(i, ["data", "component_banner", "image"], "")
              , g = (0,
            j.useTrackImpression)("MDDeepDiscountTeaser.Banner", (0,
            c.Z)({}, S, {
                banner_url: I
            }))
              , E = (0,
            j.useTrackClick)("MDDeepDiscountTeaser.Banner", (0,
            c.Z)({}, S, {
                banner_url: I
            }))
              , C = (0,
            j.useTrackImpression)("MDDeepDiscountTeaser.SeeAll", S)
              , f = (0,
            j.useTrackClick)("MDDeepDiscountTeaser.SeeAll", S);
            return p && 0 !== p.length ? (0,
            m.jsx)(j.TrackingDataAnchor, {
                targetType: "MDDeepDiscountTeaser",
                targetData: S,
                children: (0,
                m.jsxs)("section", {
                    className: "dpwCvU",
                    children: [i.component_banner.show && (0,
                    m.jsx)("img", {
                        alt: "",
                        ref: g,
                        className: "yDU8UK",
                    ...
                    m.jsx)(Pt, {
                        ...
                        numItemsPerRow: 4,
                        padding: "6px",
                        items: p.slice(0, i.num_items_display).map(( (t, e) => (0,
                        m.jsx)(Ot, {
                            item: t,
                            ImageFlag: n,
                            setting: i,
        ...
        var oe;
        const ne = function({start: t, end: e, type: s, backgroundColor: o, className: n}) {
          ...
          , re = i.useContext
          , ae = ({itemRow: t, setting: e, promotionIdMap: s, isUserAdult: i, adultAge: o, ItemCardBadges: n}) => (0,
        m.jsx)("div", {
            className: "FR7g58",
        ...
        function le({items: t, setting: e, index: s, promotionIdMap: o, timeslot: n, isUserAdult: a, adultAge: l}) {
            const {ItemCardBadges: d} = re($t);
            if (!Array.isArray(t) || 0 === t.length)
                return null;
            const _ = (t => {
                if (!t.style)
                    return;
                const {inner_background: e, inner_background_color: s} = t.style;
        ...
        var fe = function(t) {
            return t.SET_TIMESLOTS_SUCCESS = "SET_TIMESLOTS_SUCCESS",
            t.SET_TIMESLOTS_FAIL = "SET_TIMESLOTS_FAIL",
            t.FETCH_TIMESLOTS_ITEMS_REQUEST = "FETCH_TIMESLOTS_ITEMS_REQUEST",
            t.FETCH_TIMESLOTS_ITEMS_SUCCESS = "FETCH_TIMESLOTS_ITEMS_SUCCESS",
            t.FETCH_TIMESLOTS_ITEMS_FAIL = "FETCH_TIMESLOTS_ITEMS_FAIL",
            t.FETCH_ITEMS_REQUEST = "FETCH_ITEMS_REQUEST",
            t.FETCH_ITEMS_SUCCESS = "FETCH_ITEMS_SUCCESS",
            t.FETCH_ITEMS_FAIL = "FETCH_ITEMS_FAIL",
            t
        }(fe || {});
        const we = {
            status: Se.INITIAL,
          ...
          , xe = (t, e) => {
            if (e.type === fe.SET_TIMESLOTS_SUCCESS)
                return t.status !== Se.INITIAL ? t : (0,
                c.Z)({}, t, {
            ...
            if (e.type === fe.FETCH_TIMESLOTS_ITEMS_REQUEST) {
                if (t.status !== Se.FETCHING_TIMESLOTS_SUCCESS && t.status !== Se.PENDING)
                    return t;
                const {startIndex: s, endIndex: i} = e.payload;
                if (s > i)
                    return t;
                if (s !== t.maxReadyIndex + 1)
                    return t;
                const o = [];
                for (let t = e.payload.startIndex; t <= e.payload.endIndex; t++)
                    o.push(t);
                return (0,
                c.Z)({}, t, {
            ...
            if (e.type === fe.FETCH_TIMESLOTS_ITEMS_SUCCESS || e.type === fe.FETCH_TIMESLOTS_ITEMS_FAIL) {
                const {index: s} = e.payload
                  , i = e.type === fe.FETCH_TIMESLOTS_ITEMS_SUCCESS ? e.payload.res : void 0
                  , o = {}
                  , n = i && i.promo_item_list && i.promo_item_list.length > 0
                  , r = [];
                if (i && i.promo_item_list)
                    for (const t of i.promo_item_list)
                        o[qt(t.shopid, t.itemid)] = t,
                        r.push(t);
                ...
                for (; d + 1 < a.length && a[d + 1].itemRequestStatus !== Ce.ITEM_REQUEST_PENDING; )
                    d += 1;
                return t.timeslots && d + 1 >= t.timeslots.length && (m = Se.FINISH),
                (0,
                c.Z)({}, t, {
                    status: m,
            ...
            if (e.type === fe.FETCH_ITEMS_REQUEST)
                return (0,
                c.Z)({}, t, {
                    status: Se.FETCHING_ITEMS
                });
            if (e.type === fe.FETCH_ITEMS_SUCCESS) {
                var s;
                const {endIndex: i, res: o, needDeboostSoldoutItems: n} = e.payload
                  , r = (0,
                c.Z)({}, t.itemMap)
                  , a = new Set;
                if (o && o.promo_item_list)
                    for (const t of o.promo_item_list) {
                        ...
                        r[e] = t,
                        t.is_deep_discount_soldout && a.add(e)
                    }
            ...
            return e.type === fe.FETCH_ITEMS_FAIL ? (0,
            c.Z)({}, t, {
        ...
        Ht.getCountryConfig)(v.config.LOCALE) || {}).adultAge || 0
          ...
          , ve = v.I18n.withI18nCollections([Dt.pq, 34])((function(t) {
            let e = (0,
            yt.Z)(t, Ae);
            const {timeslots: s, isFetchingItems: o, finishedFetchingItems: n, fetchMoreItems: r} = function(t) {
                const [e,s] = (0,
                i.useReducer)(xe, t.component_time_slot ? we : (0,
                c.Z)({}, Ne, {
                ...
                i.useEffect)(( () => {
                    t.component_time_slot && Jt(( () => (async t => {
                        if (!Array.isArray(t.items) || 0 === t.items.length)
                            throw new Error("query.items is empty");
                        const e = await (0,
                        Gt.C8)("/api/v4/microsite/get_timeslots", {
                        ...
                        if (!e || !e.response || e.response.error || e.error)
                ...
                i.useCallback)(( () => {
                    var i;
                    if (e.status !== Se.PENDING && e.status !== Se.FETCHING_TIMESLOTS_SUCCESS)
                        return;
                    if (!t.component_time_slot) {
                        var o;
                        const i = e.nextFetchStartIndex || 0;
                        if (i >= ((null == (o = e.itemList) ? void 0 : o.length) || 0))
                            return;
                        const n = i + 120 - 1;
                        return s({
                ...
                return o.current === ce && e.status === Se.FETCHING_TIMESLOTS_SUCCESS && n(),
                o.current = e.status,
                t.component_time_slot ? {
                    timeslots: (e.timeslots || []).slice(0, e.maxReadyIndex + 1).map(( (t, s) => (0,
                    c.Z)({}, t, {
                    ...
                    fetchMoreItems: n,
                    timeslots: [{
                        itemList: (e.itemList || []).slice(0, e.nextFetchStartIndex).map(( ({item_id: t, shop_id: s}) => e.itemMap[qt(s, t)])).filter((t => Boolean(t))),
            ...
            const u = be(( () => {
                ...
                if (!s)
                    return {};
                for (const e of s)
                    for (const s of e.promo_item_id_list)
                        t[qt(s.shop_id, s.item_id)] = s.promotion_id;
                return t
            }
            ), [s])
              , {username: h, birthTimestamp: p, adultConsentTimestamp: S} = l
              , I = be(( () => (0,
            bt.Eg)({
                username: h,
                birthTimestamp: p,
...
//# sourceMappingURL=https://sourcemap.webfe.shopeemobile.com/pcmall-pagebuilder/_/2781.e05431490623f166849e.js.map
